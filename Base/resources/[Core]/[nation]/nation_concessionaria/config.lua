...
config.imgDir = "http://localhost/veiculos/" -- DIRETORIO DAS IMAGENS DOS VEÍCULOS
...
config.logo = "https://i.imgur.com/adKkJRa.png" -- LOGO DO SERVIDOR
...
config.vehList = {
	...
	{ hash = -89291282, name = 'felon2', price = 100000, banido = false, modelo = 'Felon2', capacidade = 40, tipo = 'work' },
	...
	{ hash = -4816535, name = 'skyliner34', price = 1000000, banido = false, modelo = 'Nissan Skyline', capacidade = 50, tipo = 'exclusive' },
	...
	{ hash = -145702349, name = 'fm488', price = 100000000, banido = false, modelo = 'fm488', capacidade = 90, tipo = 'exclusive' },
	{ hash = -1528734685, name = '718b', price = 100000000, banido = false, modelo = '718b', capacidade = 90, tipo = 'exclusive' },
