...
RegisterNetEvent('abrirpainel')
AddEventHandler('abrirpainel',function()
    if IsPedInAnyVehicle(PlayerPedId(), false) then
        ...
        TriggerEvent("luigi_notify:Alert","Mecânica","Você precisa estar em um veiculo para abrir o painel de tunagem.",5000,"error")
    end
end)
